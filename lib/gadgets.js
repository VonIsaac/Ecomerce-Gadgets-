...
/*export function deleteGadgets(slugs){

    return db.prepare('DELETE FROM gadgets WHERE slug = ?').run(slugs)
}*/
...
export async function saveGadgets(gadget){
    ...
    const fileName = `${gadget.slug}.${extension}`
